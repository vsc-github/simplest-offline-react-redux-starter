...
var precacheConfig = [["index.html", "29d9096e1c98f500503f64074b8a9c10"], ["static/css/main.7f976633.css", "b3fb7dcae089229160c502598efdf3ba"], ["static/js/main.1779ebe8.js", "026dc2bdda12508d582bf31ca7102a54"]],
...
self.addEventListener("install", function (e) {
    ...
    if ("GET" === e.request.method) {
        ...
        !t && "navigate" === e.request.mode && iskPathWhitelisted(["^(?!\\/__).*"], e.request.url) && (n = new URL("/react-redux-starter-kit/index.html", self.location).toString(), t = urlsToCacheKeys.has(n)), t && e.respondWith(caches.open(cacheName).then(function (e) {
